...
- minpkg fonctionne en local seulement (vous devez vous-même télécharger les sources des packages que vous voulez installer)
...
- il est assez facile de conserver plusieurs versions d'un package sans qu'il y ait de conflit
...
## En apprendre plus
Pour en apprendre plus sur le fonctionnement de minpkg, lancez-le avec l'option `--understand`.
